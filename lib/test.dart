        ...
        children: [
          ...
          ***/
          tile(
            ...
            a.fadeIn(curve: Curves.easeOutCirc).untint(color: Colors.white).blurXY(begin: 16).scaleXY(begin: 1.5),
          ),
          tile(
            'fade+blur+move',
          ...
          tile(
            ...
            a.shimmer(angle: -pi / 2, size: 3, curve: Curves.easeOutCubic).elevation(begin: 24, end: 2).flip(),
          ),
          tile(
            'shake+scale+tint',
            a.shake(curve: Curves.easeInOutCubic, hz: 3).scaleXY(begin: 0.8).tint(color: Colors.red, end: 0.6),
          ),
          tile(
            'shake+slide+slide',
            a
          ...
          ***/
          ...
          tile('shader', a.shader(shader: TestScreen.shader)),
